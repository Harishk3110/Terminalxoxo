...
class Settings(BaseSettings):
    ...
    allowed_origins: list[str] = Field(default=["http://localhost:3001", "http://127.0.0.1:3001", "http://localhost:3002", "http://127.0.0.1:3002"], alias="KNK_ALLOWED_ORIGINS")
    ...
    fred_request_timeout_seconds: float = Field(default=15.0, ge=1, le=60, allow_inf_nan=False, alias="FRED_REQUEST_TIMEOUT_SECONDS")
    fred_max_retries: int = Field(default=3, ge=1, le=5, description="Maximum total request attempts", alias="FRED_MAX_RETRIES")
