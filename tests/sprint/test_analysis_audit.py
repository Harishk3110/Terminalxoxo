...
def test_queue_and_cancel_require_an_actor_and_retain_audit(ledger_session, session_token, monkeypatch):
    ...
    with TestClient(app) as client:
        ...
        actions = ledger_session.scalars(select(models.AuditLog.action).where(models.AuditLog.resource_id == key)).all()
