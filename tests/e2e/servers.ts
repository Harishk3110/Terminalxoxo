...
export default async function setup() {
  ...
  try {
    ...
    start(process.execPath,[path.join(root,'apps/terminal-web/node_modules/next/dist/bin/next'),'start','--hostname','127.0.0.1','--port','3002','--keepAliveTimeout','70000'],path.join(root,'apps/terminal-web'),{
