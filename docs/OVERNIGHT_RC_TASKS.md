...
- [x] M2/M3: 71169ba corrects eager SQLite initialization exposed by full backend 32 (two failures / 1,881 passed). Four negative controls, 27 focused and 208 affected passes, three strict files and both browser workflows verify lazy WAL initialization and failed-connection cleanup. Whole strict 48 remains red at 660 diagnostics; full backend 33 and real integration 28 remain pending.
...
- [x] M2/M6: exact financial serialization and separate numeric performance/availability contracts; 113 affected tests, 96 complete metric summaries and two exact full valuation comparisons pass. Main valuation/position/risk typing remains open; whole strict 34 has 891 distinct diagnostics.
